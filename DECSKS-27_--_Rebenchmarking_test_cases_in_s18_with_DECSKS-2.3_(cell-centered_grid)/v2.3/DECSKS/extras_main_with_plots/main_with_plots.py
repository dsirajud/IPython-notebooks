...
sim_params = DECSKS.lib.read.inputfile('./etc/params_s18-13.dat')
...
for n in t.stepnumbers:
    fe, fi, phi = DECSKS.lib.split_with_phi_return.scheme(
        fe, fi,
        t, x, vx, ax,
        n,
        sim_params
    ...
    it_str = 'it%05d' % n
    matplotlib.pyplot.savefig('./plots/' + 'phi_s18-13' + it_str)
