...
T = 60.
Nt_01 = 120 # number of time steps, does not include time zero
t_01 = np.linspace(0,T, Nt_01+1)
...
# s07-01
I1 = file_to_array(quantity = 'I1', notebook_number = 7, sim_number = 1)

I1 = np.abs((I1 - I1[0]) / I1[0])
plt.semilogy(t_01, I1, 'Db', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s7-01')

# s07-02
I1 = file_to_array(quantity = 'I1', notebook_number = 7, sim_number = 2)
I1 = np.abs((I1 - I1[0]) / I1[0])
plt.semilogy(t_fine, I1, '-k', linewidth = 2, label = 'DECSKS-2.3: s7-02')
...
# v2.3 data
# s07-01
I2 = file_to_array(quantity = 'I2', notebook_number = 7, sim_number = 1)
I2 = np.abs((I2 - I2[0]) / I2[0])
plt.semilogy(t_01, I2, 'Db', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s7-01')

# s07-02
I2 = file_to_array(quantity = 'I2', notebook_number = 7, sim_number = 2)
I2 = np.abs((I2 - I2[0]) / I2[0])
plt.semilogy(t_fine, I2, '-k', linewidth = 2, label = 'DECSKS-2.3: s7-02')
...
# v2.3 data
# s07-01
IW = file_to_array(quantity = 'IW', notebook_number = 7, sim_number = 1)
IW = np.abs((IW - IW[0]) / IW[0])
plt.semilogy(t_01, IW, 'Db ', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s7-01')

# s07-02
IW = file_to_array(quantity = 'IW', notebook_number = 7, sim_number = 2)
IW = np.abs((IW - IW[0]) / IW[0])
plt.semilogy(t_fine, IW, '-k', linewidth = 2, label = 'DECSKS-2.3: s7-02')
...
# v2.3 data
# s07-01
S = file_to_array(quantity = 'S', notebook_number = 7, sim_number = 1)
S = np.abs((S - S[0]) / S[0])
plt.semilogy(t_01, S, 'Db', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s7-01')

# s07-02
S = file_to_array(quantity = 'S', notebook_number = 7, sim_number = 2)
S = np.abs((S - S[0]) / S[0])
plt.semilogy(t_fine, S, '-k', linewidth = 2, label = 'DECSKS2.3: s7-02')
...
# v2.3 data
# s07-01
WE = file_to_array(quantity = 'WE', notebook_number = 7, sim_number = 1)
WE = WE / WE[0]
plt.semilogy(t_01, WE, 'Db', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s7-01')


# s07-02
WE = file_to_array(quantity = 'WE', notebook_number = 7, sim_number = 2)
WE = WE / WE[0]
...
WE = WE / WE[0]
plt.semilogy(t, WE, '*m', markersize = 10, linewidth = 2, label = 'DECSKS-1.2: s7-01')
