...
T = 3.
Nt = 300 # number of time steps, does not include time zero
...
plt.semilogy(t, I2, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21')
...
plt.semilogy(t, IW, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21')
...
plt.plot(t, IQ, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21')
...
S = (S - S[0]) / S[0]
plt.semilogy(t, S, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21')
...
WE = WE / WE[0]
plt.semilogy(t, WE, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21')
