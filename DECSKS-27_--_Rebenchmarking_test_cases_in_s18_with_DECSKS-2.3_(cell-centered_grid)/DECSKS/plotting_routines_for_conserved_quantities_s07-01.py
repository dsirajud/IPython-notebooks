...
plt.semilogy(t, I1, 'Db', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s17-03')
...
plt.semilogy(t, I2, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s07-01')
...
plt.semilogy(t, IW, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s07-01')
...
S = np.abs((S - S[0]) / S[0])
plt.semilogy(t, S, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s07-01')
...
WE = WE / WE[0]
plt.semilogy(t, WE, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s07-01')
...
# s07-01
IQ = file_to_array(quantity = 'IQ', notebook_number = 07, sim_number = 01)
IQ = np.abs((IQ - IQ[0]) / IQ[0])
plt.plot(t, IQ, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s07-01')

plt.xlabel('time', fontsize = 14)
plt.ylabel('Abs. value of fractional error in the total charge $Q$ invariant', fontsize = 12)
plt.title('Fractional error in the total charge $Q$ invariant', fontsize = 14)
