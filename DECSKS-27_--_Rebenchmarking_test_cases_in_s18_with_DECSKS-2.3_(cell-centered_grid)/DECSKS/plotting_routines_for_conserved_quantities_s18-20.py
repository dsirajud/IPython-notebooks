...
plt.semilogy(t, I1, 'Db', markersize = 12, linewidth = 2, label = r'DECSKS-2.3: s18-20, $v_{th} = 0.5$')

I1 = file_to_array(quantity = 'I1', notebook_number = 18, sim_number = 20, sim_number_version = 'b')
I1 = np.abs((I1 - I1[0]) / I1[0])
plt.semilogy(t, I1, 'Dc', markersize = 12, linewidth = 2, label = r'DECSKS-2.3: s18-20b, $v_{th} = 0.0625$')

I1 = file_to_array(quantity = 'I1', notebook_number = 18, sim_number = 20, sim_number_version = 'c')
I1 = np.abs((I1 - I1[0]) / I1[0])
plt.semilogy(t, I1, 'Dm', markersize = 12, linewidth = 2, label = r'DECSKS-2.3: s18-20c, $v_{th} = 0.03125$')
...
plt.semilogy(t, IW, '-b', markersize = 12, linewidth = 2, label = r'DECSKS-2.3: s18-20, $v_{th} = 0.5$')

# s18-20
IW = file_to_array(quantity = 'IW', notebook_number = 18, sim_number = 20, sim_number_version = 'b')
IW = np.abs((IW - IW[0]) / IW[0])
plt.semilogy(t, IW, '-c', markersize = 12, linewidth = 2, label = r'DECSKS-2.3: s18-20b, $v_{th} = 0.0625$')

# s18-20
IW = file_to_array(quantity = 'IW', notebook_number = 18, sim_number = 20, sim_number_version = 'c')
IW = np.abs((IW - IW[0]) / IW[0])
plt.semilogy(t, IW, '-m', markersize = 12, linewidth = 2, label = r'DECSKS-2.3: s18-20c, $v_{th} = 0.03125$')
...
WE = WE / WE[0]
plt.semilogy(t, WE, '--b', markersize = 12, linewidth = 2, label = r'DECSKS-2.3: s18-20, $v_{th} = 0.5$')

WE = file_to_array(quantity = 'WE', notebook_number = 18, sim_number = 20, sim_number_version = 'b')
WE = WE / WE[0]
plt.semilogy(t, WE, '--c', markersize = 12, linewidth = 2, label = r'DECSKS-2.3: s18-20b, $v_{th} = 0.0625$')

WE = file_to_array(quantity = 'WE', notebook_number = 18, sim_number = 20, sim_number_version = 'c')
WE = WE / WE[0]
plt.semilogy(t, WE, '--m', markersize = 12, linewidth = 2, label = r'DECSKS-2.3: s18-20c, $v_{th} = 0.03125$')
...
plt.title('DECSKS-2.3: Normalized electrostatic energy, $W_E / W_{E0}$')
