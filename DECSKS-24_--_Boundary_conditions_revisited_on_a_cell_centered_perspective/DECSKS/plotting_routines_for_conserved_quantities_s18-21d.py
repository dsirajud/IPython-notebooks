...
def file_to_array(quantity = 'I1', notebook_number = 7, sim_number = 21, version = ''):
    ...
    # assemble filepath
    sim_name = 'out_' + quantity + '_' + 's' + str(notebook_number) + '-' + str(sim_number) + 'd'
...
plt.plot(t, I1, 'Db', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21d')
...
plt.semilogy(t, I2, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21d')
...
plt.semilogy(t, IW, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21d')
...
# s18-21d
IQ = file_to_array(quantity = 'IQ', notebook_number = 18, sim_number = 21)
plt.semilogy(t, IQ, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21d')

#plt.axis([0,T,1e-16, 1e-5])
plt.xlabel('time', fontsize = 14)
plt.ylabel('Abs. value of fractional error in total charge, $I_Q$', fontsize = 12)
plt.title('Fractional error in the total energy invariant $I_Q$', fontsize = 14)
plt.legend(loc = 'best')
plt.grid()
plt.figure()
...
S = (S - S[0]) / S[0]
plt.plot(t, S, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21d')
...
WE = WE / WE[0]
plt.semilogy(t, WE, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-21d')
