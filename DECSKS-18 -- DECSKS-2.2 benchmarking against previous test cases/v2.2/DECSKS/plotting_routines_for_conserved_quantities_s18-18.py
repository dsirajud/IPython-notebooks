...
def file_to_array(quantity = 'I1', notebook_number = 7, sim_number = 18, version = ''):
...
T = 90.
Nt = 180 # number of time steps, does not include time zero
t = np.linspace(0,T, Nt+1)

# I1

# s17-03
I1 = file_to_array(quantity = 'I1', notebook_number = 18, sim_number = 18)
...
# s18-18
I2 = file_to_array(quantity = 'I2', notebook_number = 18, sim_number = 18)
I2 = np.abs((I2 - I2[0]) / I2[0])
plt.semilogy(t, I2, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-18')
...
# s18-18
IW = file_to_array(quantity = 'IW', notebook_number = 18, sim_number = 18)
IW = np.abs((IW - IW[0]) / IW[0])
plt.semilogy(t, IW, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-18')
...
# s18-18
S = file_to_array(quantity = 'S', notebook_number = 18, sim_number = 18)
S = np.abs((S - S[0]) / S[0])
plt.semilogy(t, S, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-18')
...
# s18-18
WE = file_to_array(quantity = 'WE', notebook_number = 18, sim_number = 18)
WE = WE / WE[0]
plt.semilogy(t, WE, '-b', markersize = 12, linewidth = 2, label = 'DECSKS-2.2: s18-18')
