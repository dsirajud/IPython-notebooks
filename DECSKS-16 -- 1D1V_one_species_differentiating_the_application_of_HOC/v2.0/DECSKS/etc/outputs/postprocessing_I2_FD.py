...
infile = open('../../../../v1.2/DECSKS/etc/outputs/s7-03/out_I2','r')
lines = infile.readlines()
...
plt.ylabel('Fractional error in $L_2$ norm', fontsize = 12)
plt.legend(loc = 'best')
plt.savefig('Landau_I2_FD.png')
plt.clf()
