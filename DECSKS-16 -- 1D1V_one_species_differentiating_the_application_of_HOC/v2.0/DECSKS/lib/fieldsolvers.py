...
def compute_electric_field_fd(f, x, vx, n, sim_params):

    phi = Poisson_PBC_6th_1D1V(sim_params['ni'], f, x, vx, n, sim_params)
...
def compute_electric_field_fourier(f, x, vx, n, sim_params):

    Ex = Gauss1D1V(sim_params['ni'], f, x, vx, n, sim_params) # calculate accelerations at time zero (n-1)
    return Ex
