...
def setup():
    ...
    #setup = "import _mypath; import DECSKS; from fourier_timeit import setup, fourier, trigonometric2D; f, sim_params, x = setup(); import numpy as np; d = np.zeros([N, Nx, Nv])"
