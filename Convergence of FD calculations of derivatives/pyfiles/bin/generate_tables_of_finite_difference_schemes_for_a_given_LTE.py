...
if __name__ == '__main__':
    ...
    rel_path = './../etc/'     # script run from pyfiles/bin and writes to pyfiles/etc
    decorated_out, dn_schemes_out = misc.write_header(rel_path, dn, p)
