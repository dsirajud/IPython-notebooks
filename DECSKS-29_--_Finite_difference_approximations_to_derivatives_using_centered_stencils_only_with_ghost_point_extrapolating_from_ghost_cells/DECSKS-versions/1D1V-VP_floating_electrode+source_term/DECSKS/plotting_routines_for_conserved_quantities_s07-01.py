...
plt.semilogy(t, I1, 'oc', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s7-01')
...
plt.semilogy(t, I2, 'oc', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s7-01')
...
plt.semilogy(t, IW, 'oc', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s7-01')
...
S = np.abs((S - S[0]) / S[0])
plt.semilogy(t, S, 'oc', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s7-01')
...
WE = WE / WE[0]
plt.semilogy(t, WE, 'oc', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s7-01')
