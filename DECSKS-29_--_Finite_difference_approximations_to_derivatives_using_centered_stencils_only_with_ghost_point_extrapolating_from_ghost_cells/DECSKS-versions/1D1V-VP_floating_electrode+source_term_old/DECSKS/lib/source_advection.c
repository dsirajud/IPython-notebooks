...
#endif
#include <math.h>
#define __PYX_HAVE__DECSKS__lib__source_advection
#define __PYX_HAVE_API__DECSKS__lib__source_advection
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
static const char *__pyx_f[] = {
  "DECSKS/lib/source_advection.pyx",
  "__init__.pxd",
  "type.pxd",
};
...
/* "DECSKS/lib/source_advection.pyx":8
 * DTYPEINT = np.int64
 * 
 ...
 * 
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t;

/* "DECSKS/lib/source_advection.pyx":9
 * 
 * ctypedef np.float64_t DTYPE_t
 * ctypedef np.int64_t DTYPEINT_t             # <<<<<<<<<<<<<<
 * 
 ...
 */
typedef __pyx_t_5numpy_int64_t __pyx_t_6DECSKS_3lib_16source_advection_DTYPEINT_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'DECSKS.lib.source_advection' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPEINT_t = { "DTYPEINT_t", NULL, sizeof(__pyx_t_6DECSKS_3lib_16source_advection_DTYPEINT_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_6DECSKS_3lib_16source_advection_DTYPEINT_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_6DECSKS_3lib_16source_advection_DTYPEINT_t), 0 };
#define __Pyx_MODULE_NAME "DECSKS.lib.source_advection"
int __pyx_module_is_main_DECSKS__lib__source_advection = 0;

/* Implementation of 'DECSKS.lib.source_advection' */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_6DECSKS_3lib_16source_advection_create_postpoint_objects(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_S, PyArrayObject *__pyx_v_GCFL_int, PyArrayObject *__pyx_v_GCFL_frac, int __pyx_v_num_stages, int __pyx_v_Nx, int __pyx_v_Nvx, __pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t __pyx_v_xwidth, __pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t __pyx_v_vxwidth, CYTHON_UNUSED PyObject *__pyx_v_sim_params); /* proto */
...
static char __pyx_k_Nvx[] = "Nvx";
static char __pyx_k_abs[] = "abs";
static char __pyx_k_f_S[] = "f_S";
static char __pyx_k_max[] = "max";
static char __pyx_k_main[] = "__main__";
static char __pyx_k_test[] = "__test__";
static char __pyx_k_DTYPE[] = "DTYPE";
static char __pyx_k_S_Nvx[] = "S_Nvx";
static char __pyx_k_int64[] = "int64";
static char __pyx_k_numpy[] = "numpy";
static char __pyx_k_range[] = "range";
static char __pyx_k_zeros[] = "zeros";
static char __pyx_k_g_crit[] = "g_crit";
static char __pyx_k_import[] = "__import__";
static char __pyx_k_xwidth[] = "xwidth";
static char __pyx_k_float64[] = "float64";
static char __pyx_k_vxwidth[] = "vxwidth";
static char __pyx_k_DTYPEINT[] = "DTYPEINT";
static char __pyx_k_GCFL_int[] = "GCFL_int";
static char __pyx_k_GCFL_frac[] = "GCFL_frac";
static char __pyx_k_ValueError[] = "ValueError";
static char __pyx_k_num_stages[] = "num_stages";
static char __pyx_k_sim_params[] = "sim_params";
static char __pyx_k_RuntimeError[] = "RuntimeError";
static char __pyx_k_create_postpoint_objects[] = "create_postpoint_objects";
static char __pyx_k_DECSKS_lib_source_advection[] = "DECSKS.lib.source_advection";
static char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static char __pyx_k_home_dsirajud_Work_IPython_note[] = "/home/dsirajud/Work/IPython-notebooks/DECSKS-28_--_Including_an_in-flow_source_term_by_launching_from_ghost_cells/v2.3/DECSKS/lib/source_advection.pyx";
static char __pyx_k_unknown_dtype_code_in_numpy_pxd[] = "unknown dtype code in numpy.pxd (%d)";
static char __pyx_k_Format_string_allocated_too_shor[] = "Format string allocated too short, see comment in numpy.pxd";
static char __pyx_k_Non_native_byte_order_not_suppor[] = "Non-native byte order not supported";
static char __pyx_k_ndarray_is_not_Fortran_contiguou[] = "ndarray is not Fortran contiguous";
static char __pyx_k_Format_string_allocated_too_shor_2[] = "Format string allocated too short.";
static PyObject *__pyx_n_s_DECSKS_lib_source_advection;
static PyObject *__pyx_n_s_DTYPE;
static PyObject *__pyx_n_s_DTYPEINT;
static PyObject *__pyx_kp_u_Format_string_allocated_too_shor;
static PyObject *__pyx_kp_u_Format_string_allocated_too_shor_2;
static PyObject *__pyx_n_s_GCFL_frac;
static PyObject *__pyx_n_s_GCFL_int;
static PyObject *__pyx_n_s_NG;
static PyObject *__pyx_n_s_N_S;
static PyObject *__pyx_kp_u_Non_native_byte_order_not_suppor;
static PyObject *__pyx_n_s_Nvx;
static PyObject *__pyx_n_s_Nx;
static PyObject *__pyx_n_s_RuntimeError;
static PyObject *__pyx_n_s_S;
static PyObject *__pyx_n_s_S_Nvx;
static PyObject *__pyx_n_s_ValueError;
static PyObject *__pyx_n_s_abs;
static PyObject *__pyx_n_s_create_postpoint_objects;
static PyObject *__pyx_n_s_f_S;
static PyObject *__pyx_n_s_float64;
static PyObject *__pyx_n_s_g;
static PyObject *__pyx_n_s_g_crit;
...
static PyObject *__pyx_n_s_num_stages;
...
static PyObject *__pyx_n_s_vxwidth;
...
/* "DECSKS/lib/source_advection.pyx":12
 * 
 * @cython.boundscheck(False)
...
/* Python wrapper */
static PyObject *__pyx_pw_6DECSKS_3lib_16source_advection_1create_postpoint_objects(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6DECSKS_3lib_16source_advection_create_postpoint_objects[] = "\n    create objects f_S and N_S that are the objects that capture\n    the effect of a bulk source flowing in from the right\n\n    inputs:\n    S -- (ndarray, ndim=1) source function data, contains only data for vx < 0\n    GCFL_int -- (ndarray, ndim=2) indexed [s,j], int(CFL) for stage s at vx j\n    GCFL_frac -- (ndarray, ndim=2) indexed [s,j], frac(CFL) for stage s at vx j\n    num _stages -- (int) sim_params['splitting']['number_of_stages']['a'],\n                   total number of stages\n\n    Nx  -- (int) total number of x gridpoints\n    Nvx -- (int) total number of vx gridpoints\n    sim_params -- (dict) simulation paramters\n\n    outputs:\n    f_S -- (ndarray, ndim=3), shape = (stages+1, x.N, vx.N) density array that is\n           the contribution of the source particles to every [i,j] for\n           a velocity dependent distribution function\n\n    N_S -- (ndarray, ndim = 1), shape = (stages+1,) the number of source\n            particles that reach the lower boundary\n\n    see notebook s28 for details\n    ";
static PyMethodDef __pyx_mdef_6DECSKS_3lib_16source_advection_1create_postpoint_objects = {"create_postpoint_objects", (PyCFunction)__pyx_pw_6DECSKS_3lib_16source_advection_1create_postpoint_objects, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6DECSKS_3lib_16source_advection_create_postpoint_objects};
static PyObject *__pyx_pw_6DECSKS_3lib_16source_advection_1create_postpoint_objects(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_S = 0;
  PyArrayObject *__pyx_v_GCFL_int = 0;
  PyArrayObject *__pyx_v_GCFL_frac = 0;
  int __pyx_v_num_stages;
  int __pyx_v_Nx;
  int __pyx_v_Nvx;
  __pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t __pyx_v_xwidth;
  __pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t __pyx_v_vxwidth;
  ...
  __Pyx_RefNannySetupContext("create_postpoint_objects (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_S,&__pyx_n_s_GCFL_int,&__pyx_n_s_GCFL_frac,&__pyx_n_s_num_stages,&__pyx_n_s_Nx,&__pyx_n_s_Nvx,&__pyx_n_s_xwidth,&__pyx_n_s_vxwidth,&__pyx_n_s_sim_params,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_GCFL_int)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_postpoint_objects", 1, 9, 9, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_GCFL_frac)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_postpoint_objects", 1, 9, 9, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_num_stages)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_postpoint_objects", 1, 9, 9, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Nx)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_postpoint_objects", 1, 9, 9, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Nvx)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_postpoint_objects", 1, 9, 9, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_xwidth)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_postpoint_objects", 1, 9, 9, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_vxwidth)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_postpoint_objects", 1, 9, 9, 7); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sim_params)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_postpoint_objects", 1, 9, 9, 8); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "create_postpoint_objects") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_GCFL_int = ((PyArrayObject *)values[1]);
    __pyx_v_GCFL_frac = ((PyArrayObject *)values[2]);
    __pyx_v_num_stages = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_num_stages == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_Nx = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_Nx == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_Nvx = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_Nvx == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_xwidth = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_xwidth == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_vxwidth = __pyx_PyFloat_AsDouble(values[7]); if (unlikely((__pyx_v_vxwidth == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_sim_params = values[8];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("create_postpoint_objects", 1, 9, 9, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("DECSKS.lib.source_advection.create_postpoint_objects", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_GCFL_int), __pyx_ptype_5numpy_ndarray, 1, "GCFL_int", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_GCFL_frac), __pyx_ptype_5numpy_ndarray, 1, "GCFL_frac", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_6DECSKS_3lib_16source_advection_create_postpoint_objects(__pyx_self, __pyx_v_S, __pyx_v_GCFL_int, __pyx_v_GCFL_frac, __pyx_v_num_stages, __pyx_v_Nx, __pyx_v_Nvx, __pyx_v_xwidth, __pyx_v_vxwidth, __pyx_v_sim_params);
...
static PyObject *__pyx_pf_6DECSKS_3lib_16source_advection_create_postpoint_objects(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_S, PyArrayObject *__pyx_v_GCFL_int, PyArrayObject *__pyx_v_GCFL_frac, int __pyx_v_num_stages, int __pyx_v_Nx, int __pyx_v_Nvx, __pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t __pyx_v_xwidth, __pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t __pyx_v_vxwidth, CYTHON_UNUSED PyObject *__pyx_v_sim_params) {
  int __pyx_v_S_Nvx;
  int __pyx_v_s;
  int __pyx_v_j;
  int __pyx_v_k1;
  int __pyx_v_k2;
  PyArrayObject *__pyx_v_f_S = 0;
  PyArrayObject *__pyx_v_N_S = 0;
  PyObject *__pyx_v_NG = NULL;
  PyObject *__pyx_v_g_crit = NULL;
  PyObject *__pyx_v_g = NULL;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_GCFL_frac;
  __Pyx_Buffer __pyx_pybuffer_GCFL_frac;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_GCFL_int;
  __Pyx_Buffer __pyx_pybuffer_GCFL_int;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_N_S;
  __Pyx_Buffer __pyx_pybuffer_N_S;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_S;
  __Pyx_Buffer __pyx_pybuffer_S;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_f_S;
  __Pyx_Buffer __pyx_pybuffer_f_S;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("create_postpoint_objects", 0);
  __pyx_pybuffer_f_S.pybuffer.buf = NULL;
  __pyx_pybuffer_f_S.refcount = 0;
  __pyx_pybuffernd_f_S.data = NULL;
  __pyx_pybuffernd_f_S.rcbuffer = &__pyx_pybuffer_f_S;
  __pyx_pybuffer_N_S.pybuffer.buf = NULL;
  __pyx_pybuffer_N_S.refcount = 0;
  __pyx_pybuffernd_N_S.data = NULL;
  __pyx_pybuffernd_N_S.rcbuffer = &__pyx_pybuffer_N_S;
  ...
  __pyx_pybuffer_GCFL_int.pybuffer.buf = NULL;
  __pyx_pybuffer_GCFL_int.refcount = 0;
  __pyx_pybuffernd_GCFL_int.data = NULL;
  __pyx_pybuffernd_GCFL_int.rcbuffer = &__pyx_pybuffer_GCFL_int;
  __pyx_pybuffer_GCFL_frac.pybuffer.buf = NULL;
  __pyx_pybuffer_GCFL_frac.refcount = 0;
  __pyx_pybuffernd_GCFL_frac.data = NULL;
  __pyx_pybuffernd_GCFL_frac.rcbuffer = &__pyx_pybuffer_GCFL_frac;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_S.rcbuffer->pybuffer, (PyObject*)__pyx_v_S, &__Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_GCFL_int.rcbuffer->pybuffer, (PyObject*)__pyx_v_GCFL_int, &__Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPEINT_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_GCFL_int.diminfo[0].strides = __pyx_pybuffernd_GCFL_int.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_GCFL_int.diminfo[0].shape = __pyx_pybuffernd_GCFL_int.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_GCFL_int.diminfo[1].strides = __pyx_pybuffernd_GCFL_int.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_GCFL_int.diminfo[1].shape = __pyx_pybuffernd_GCFL_int.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer, (PyObject*)__pyx_v_GCFL_frac, &__Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_GCFL_frac.diminfo[0].strides = __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_GCFL_frac.diminfo[0].shape = __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_GCFL_frac.diminfo[1].strides = __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_GCFL_frac.diminfo[1].shape = __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.shape[1];

  /* "DECSKS/lib/source_advection.pyx":47
 *     see notebook s28 for details
 *     """
 ...
 *     cdef int k1, k2
 */
  __pyx_t_1 = PyObject_Length(((PyObject *)__pyx_v_S)); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_S_Nvx = __pyx_t_1;

  /* "DECSKS/lib/source_advection.pyx":52
 * 
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyInt_From_long((__pyx_v_num_stages + 1)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_Nx); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_Nvx); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (!__pyx_t_6) {
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_7); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_f_S.rcbuffer->pybuffer, (PyObject*)__pyx_t_8, &__Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 3, 0, __pyx_stack) == -1)) {
      __pyx_v_f_S = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_f_S.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_f_S.diminfo[0].strides = __pyx_pybuffernd_f_S.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_f_S.diminfo[0].shape = __pyx_pybuffernd_f_S.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_f_S.diminfo[1].strides = __pyx_pybuffernd_f_S.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_f_S.diminfo[1].shape = __pyx_pybuffernd_f_S.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_f_S.diminfo[2].strides = __pyx_pybuffernd_f_S.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_f_S.diminfo[2].shape = __pyx_pybuffernd_f_S.rcbuffer->pybuffer.shape[2];
    }
  }
  __pyx_t_8 = 0;
  __pyx_v_f_S = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "DECSKS/lib/source_advection.pyx":55
 * 
 *     # initialize a 1D array indexed by s, the stage (s >= 1; s = 0 entry is empty)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_num_stages + 1)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_7 = NULL;
  ...
  if (!__pyx_t_7) {
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_4); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_GOTREF(__pyx_t_2);
  } else {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_N_S.rcbuffer->pybuffer, (PyObject*)__pyx_t_9, &__Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_N_S = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_N_S.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_N_S.diminfo[0].strides = __pyx_pybuffernd_N_S.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_N_S.diminfo[0].shape = __pyx_pybuffernd_N_S.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_9 = 0;
  __pyx_v_N_S = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "DECSKS/lib/source_advection.pyx":57
 *     cdef np.ndarray[DTYPE_t, ndim=1] N_S = np.zeros(num_stages + 1)
 * 
 *     for s in range(1, num_stages + 1):             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_12 = __pyx_v_S_Nvx;
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      __pyx_v_j = __pyx_t_13;

      /* "DECSKS/lib/source_advection.pyx":60
 *         for j in range(S_Nvx):
 * 
 *             NG = np.abs(GCFL_int[s,j]) + 1 # each j requires NG ghost cells             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_abs); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_14 = __pyx_v_s;
      __pyx_t_15 = __pyx_v_j;
      if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_pybuffernd_GCFL_int.diminfo[0].shape;
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_pybuffernd_GCFL_int.diminfo[1].shape;
      __pyx_t_5 = __Pyx_PyInt_From_npy_int64((*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPEINT_t *, __pyx_pybuffernd_GCFL_int.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_GCFL_int.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_GCFL_int.diminfo[1].strides))); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_4 = NULL;
      ...
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_6 = PyNumber_Add(__pyx_t_2, __pyx_int_1); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_XDECREF_SET(__pyx_v_NG, __pyx_t_6);
      __pyx_t_6 = 0;

      /* "DECSKS/lib/source_advection.pyx":61
 * 
 *             NG = np.abs(GCFL_int[s,j]) + 1 # each j requires NG ghost cells
 *             g_crit = np.abs(GCFL_int[s,j]) - Nx # the critical ghost index g (in configuration, i = Nx + g) for a given j where g < g_crit reaches the wall, g >= g_crit maps on-grid             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_abs); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_16 = __pyx_v_s;
      __pyx_t_17 = __pyx_v_j;
      if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_pybuffernd_GCFL_int.diminfo[0].shape;
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_pybuffernd_GCFL_int.diminfo[1].shape;
      __pyx_t_2 = __Pyx_PyInt_From_npy_int64((*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPEINT_t *, __pyx_pybuffernd_GCFL_int.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_GCFL_int.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_GCFL_int.diminfo[1].strides))); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_5 = NULL;
      ...
      if (!__pyx_t_5) {
        __pyx_t_6 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_2); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_GOTREF(__pyx_t_6);
      } else {
        ...
        __pyx_t_2 = 0;
        __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_4, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      }
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_Nx); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_4 = PyNumber_Subtract(__pyx_t_6, __pyx_t_7); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_XDECREF_SET(__pyx_v_g_crit, __pyx_t_4);
      __pyx_t_4 = 0;

      /* "DECSKS/lib/source_advection.pyx":63
 *             g_crit = np.abs(GCFL_int[s,j]) - Nx # the critical ghost index g (in configuration, i = Nx + g) for a given j where g < g_crit reaches the wall, g >= g_crit maps on-grid
 * 
 *             for g in range(NG): # indexes position of ghost cell: i = Nx + g             # <<<<<<<<<<<<<<
 ...
 */
      ...
      PyTuple_SET_ITEM(__pyx_t_4, 0, __pyx_v_NG);
      __pyx_t_7 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_4, NULL); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      if (likely(PyList_CheckExact(__pyx_t_7)) || PyTuple_CheckExact(__pyx_t_7)) {
        ...
        __pyx_t_1 = -1; __pyx_t_4 = PyObject_GetIter(__pyx_t_7); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_18 = Py_TYPE(__pyx_t_4)->tp_iternext; if (unlikely(!__pyx_t_18)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      for (;;) {
        if (likely(!__pyx_t_18)) {
          if (likely(PyList_CheckExact(__pyx_t_4))) {
            ...
            #if CYTHON_COMPILING_IN_CPYTHON
            __pyx_t_7 = PyList_GET_ITEM(__pyx_t_4, __pyx_t_1); __Pyx_INCREF(__pyx_t_7); __pyx_t_1++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
            #else
            __pyx_t_7 = PySequence_ITEM(__pyx_t_4, __pyx_t_1); __pyx_t_1++; if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
            __Pyx_GOTREF(__pyx_t_7);
            #endif
          } else {
            if (__pyx_t_1 >= PyTuple_GET_SIZE(__pyx_t_4)) break;
            #if CYTHON_COMPILING_IN_CPYTHON
            __pyx_t_7 = PyTuple_GET_ITEM(__pyx_t_4, __pyx_t_1); __Pyx_INCREF(__pyx_t_7); __pyx_t_1++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
            #else
            __pyx_t_7 = PySequence_ITEM(__pyx_t_4, __pyx_t_1); __pyx_t_1++; if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
            __Pyx_GOTREF(__pyx_t_7);
            #endif
        ...
        /* "DECSKS/lib/source_advection.pyx":67
 *                 # worked out, see notebook s28
 * 
 ...
 */
        __pyx_t_7 = PyObject_RichCompare(__pyx_int_0, __pyx_v_g, Py_LE); __Pyx_XGOTREF(__pyx_t_7); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        if (__Pyx_PyObject_IsTrue(__pyx_t_7)) {
          __Pyx_DECREF(__pyx_t_7);
          __pyx_t_7 = PyObject_RichCompare(__pyx_v_g, __pyx_v_g_crit, Py_LT); __Pyx_XGOTREF(__pyx_t_7); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_t_19 = __Pyx_PyObject_IsTrue(__pyx_t_7); if (unlikely(__pyx_t_19 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        if (__pyx_t_19) {

          /* "DECSKS/lib/source_advection.pyx":68
 * 
 *                 if 0 <= g < g_crit: # both proportions k1 and k2 reach boundary
 *                     N_S[s] +=  S[j] * (1 + GCFL_frac[s,j])             # <<<<<<<<<<<<<<
 *                     N_S[s] += -S[j] *  GCFL_frac[s,j]
 ...
 */
          ...
          if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
          if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
          __pyx_t_23 = __pyx_v_s;
          if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_pybuffernd_N_S.diminfo[0].shape;
          *__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_N_S.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_N_S.diminfo[0].strides) += ((*__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_S.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_S.diminfo[0].strides)) * (1.0 + (*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides))));

          /* "DECSKS/lib/source_advection.pyx":69
 *                 if 0 <= g < g_crit: # both proportions k1 and k2 reach boundary
 *                     N_S[s] +=  S[j] * (1 + GCFL_frac[s,j])
 *                     N_S[s] += -S[j] *  GCFL_frac[s,j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_pybuffernd_S.diminfo[0].shape;
          __pyx_t_25 = __pyx_v_s;
          __pyx_t_26 = __pyx_v_j;
          if (__pyx_t_25 < 0) __pyx_t_25 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
          if (__pyx_t_26 < 0) __pyx_t_26 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
          __pyx_t_27 = __pyx_v_s;
          if (__pyx_t_27 < 0) __pyx_t_27 += __pyx_pybuffernd_N_S.diminfo[0].shape;
          *__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_N_S.rcbuffer->pybuffer.buf, __pyx_t_27, __pyx_pybuffernd_N_S.diminfo[0].strides) += ((-(*__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_S.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_S.diminfo[0].strides))) * (*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_26, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides)));
          goto __pyx_L9;
        }

        /* "DECSKS/lib/source_advection.pyx":71
 *                     N_S[s] += -S[j] *  GCFL_frac[s,j]
 * 
 *                 elif g == g_crit: # edge case, ghost prepoints reach i in [-1,0]             # <<<<<<<<<<<<<<
 ...
 * 
 */
        __pyx_t_7 = PyObject_RichCompare(__pyx_v_g, __pyx_v_g_crit, Py_EQ); __Pyx_XGOTREF(__pyx_t_7); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __pyx_t_19 = __Pyx_PyObject_IsTrue(__pyx_t_7); if (unlikely(__pyx_t_19 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        if (__pyx_t_19) {

          /* "DECSKS/lib/source_advection.pyx":74
 *                                   # lower boundary at i = -1/2
 * 
 ...
 */
          ...
          if (__pyx_t_28 < 0) __pyx_t_28 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
          if (__pyx_t_29 < 0) __pyx_t_29 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
          __pyx_t_19 = (((-(*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_29, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides))) > (1.0 / 2.)) != 0);
          if (__pyx_t_19) {

            /* "DECSKS/lib/source_advection.pyx":76
 *                     if -GCFL_frac[s,j] > 1/2.: # both k1 and k2 reach boundary
 *                         # physically k1 = -1/2, k2 = -1
 *                         N_S[s] +=  S[j] * (1 + GCFL_frac[s,j])             # <<<<<<<<<<<<<<
 *                         N_S[s] += -S[j] *  GCFL_frac[s,j]
 ...
 */
            ...
            if (__pyx_t_30 < 0) __pyx_t_30 += __pyx_pybuffernd_S.diminfo[0].shape;
            __pyx_t_31 = __pyx_v_s;
            __pyx_t_32 = __pyx_v_j;
            if (__pyx_t_31 < 0) __pyx_t_31 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
            if (__pyx_t_32 < 0) __pyx_t_32 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
            __pyx_t_33 = __pyx_v_s;
            if (__pyx_t_33 < 0) __pyx_t_33 += __pyx_pybuffernd_N_S.diminfo[0].shape;
            *__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_N_S.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_N_S.diminfo[0].strides) += ((*__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_S.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_S.diminfo[0].strides)) * (1.0 + (*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_32, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides))));

            /* "DECSKS/lib/source_advection.pyx":77
 *                         # physically k1 = -1/2, k2 = -1
 *                         N_S[s] +=  S[j] * (1 + GCFL_frac[s,j])
 *                         N_S[s] += -S[j] *  GCFL_frac[s,j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
            ...
            if (__pyx_t_34 < 0) __pyx_t_34 += __pyx_pybuffernd_S.diminfo[0].shape;
            __pyx_t_35 = __pyx_v_s;
            __pyx_t_36 = __pyx_v_j;
            if (__pyx_t_35 < 0) __pyx_t_35 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
            if (__pyx_t_36 < 0) __pyx_t_36 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
            __pyx_t_37 = __pyx_v_s;
            if (__pyx_t_37 < 0) __pyx_t_37 += __pyx_pybuffernd_N_S.diminfo[0].shape;
            *__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_N_S.rcbuffer->pybuffer.buf, __pyx_t_37, __pyx_pybuffernd_N_S.diminfo[0].strides) += ((-(*__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_S.rcbuffer->pybuffer.buf, __pyx_t_34, __pyx_pybuffernd_S.diminfo[0].strides))) * (*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_35, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_36, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides)));
            goto __pyx_L10;
          }

          /* "DECSKS/lib/source_advection.pyx":79
 *                         N_S[s] += -S[j] *  GCFL_frac[s,j]
 * 
 *                     elif -GCFL_frac[s,j] < 1/2.: # k2 reaches boundary, k1 on grid             # <<<<<<<<<<<<<<
 ...
 */
          ...
          if (__pyx_t_38 < 0) __pyx_t_38 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
          if (__pyx_t_39 < 0) __pyx_t_39 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
          __pyx_t_19 = (((-(*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_38, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_39, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides))) < (1.0 / 2.)) != 0);
          if (__pyx_t_19) {

            /* "DECSKS/lib/source_advection.pyx":82
 *                         # physically k1 = 0, k2 = -1/2
 * 
 ...
 */
            ...
            if (__pyx_t_40 < 0) __pyx_t_40 += __pyx_pybuffernd_S.diminfo[0].shape;
            __pyx_t_41 = __pyx_v_s;
            __pyx_t_42 = __pyx_v_j;
            if (__pyx_t_41 < 0) __pyx_t_41 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
            if (__pyx_t_42 < 0) __pyx_t_42 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
            __pyx_t_43 = __pyx_v_s;
            __pyx_t_44 = __pyx_v_k1;
            __pyx_t_45 = __pyx_v_j;
            if (__pyx_t_43 < 0) __pyx_t_43 += __pyx_pybuffernd_f_S.diminfo[0].shape;
            if (__pyx_t_44 < 0) __pyx_t_44 += __pyx_pybuffernd_f_S.diminfo[1].shape;
            if (__pyx_t_45 < 0) __pyx_t_45 += __pyx_pybuffernd_f_S.diminfo[2].shape;
            *__Pyx_BufPtrStrided3d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_f_S.rcbuffer->pybuffer.buf, __pyx_t_43, __pyx_pybuffernd_f_S.diminfo[0].strides, __pyx_t_44, __pyx_pybuffernd_f_S.diminfo[1].strides, __pyx_t_45, __pyx_pybuffernd_f_S.diminfo[2].strides) += ((*__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_S.rcbuffer->pybuffer.buf, __pyx_t_40, __pyx_pybuffernd_S.diminfo[0].strides)) * (1.0 + (2.0 * (*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_41, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_42, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides)))));

            /* "DECSKS/lib/source_advection.pyx":83
 * 
 *                         f_S[s,k1,j] += S[j] * (1 + 2 * GCFL_frac[s,j])
 *                         N_S[s] += -2 * S[j] *  GCFL_frac[s,j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
            ...
            if (__pyx_t_46 < 0) __pyx_t_46 += __pyx_pybuffernd_S.diminfo[0].shape;
            __pyx_t_47 = __pyx_v_s;
            __pyx_t_48 = __pyx_v_j;
            if (__pyx_t_47 < 0) __pyx_t_47 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
            if (__pyx_t_48 < 0) __pyx_t_48 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
            __pyx_t_49 = __pyx_v_s;
            if (__pyx_t_49 < 0) __pyx_t_49 += __pyx_pybuffernd_N_S.diminfo[0].shape;
            *__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_N_S.rcbuffer->pybuffer.buf, __pyx_t_49, __pyx_pybuffernd_N_S.diminfo[0].strides) += ((-2.0 * (*__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_S.rcbuffer->pybuffer.buf, __pyx_t_46, __pyx_pybuffernd_S.diminfo[0].strides))) * (*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_47, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_48, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides)));
            goto __pyx_L10;
          }
          __pyx_L10:;
          goto __pyx_L9;
        ...
        /* "DECSKS/lib/source_advection.pyx":85
 *                         N_S[s] += -2 * S[j] *  GCFL_frac[s,j]
 * 
 *                 elif np.max((g_crit + 1, 0)) <= g < NG-1:             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_max); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_t_6 = PyNumber_Add(__pyx_v_g_crit, __pyx_int_1); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        ...
        if (!__pyx_t_6) {
          __pyx_t_7 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_5); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __Pyx_GOTREF(__pyx_t_7);
        } else {
        ...
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_t_2 = PyObject_RichCompare(__pyx_t_7, __pyx_v_g, Py_LE); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        if (__Pyx_PyObject_IsTrue(__pyx_t_2)) {
          __Pyx_DECREF(__pyx_t_2);
          __pyx_t_3 = PyNumber_Subtract(__pyx_v_NG, __pyx_int_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_3);
          __pyx_t_2 = PyObject_RichCompare(__pyx_v_g, __pyx_t_3, Py_LT); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        }
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __pyx_t_19 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_19 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        if (__pyx_t_19) {

          /* "DECSKS/lib/source_advection.pyx":88
 * 
 *                     # both proportions map on-grid to points (g + GCFL.int[s,j]) and (g + GCFL.int[s,j] - 1)
 *                     k1 = g + GCFL_int[s,j]             # <<<<<<<<<<<<<<
 *                     k2 = k1 - 1
 ...
 */
          ...
          if (__pyx_t_50 < 0) __pyx_t_50 += __pyx_pybuffernd_GCFL_int.diminfo[0].shape;
          if (__pyx_t_51 < 0) __pyx_t_51 += __pyx_pybuffernd_GCFL_int.diminfo[1].shape;
          __pyx_t_2 = __Pyx_PyInt_From_npy_int64((*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPEINT_t *, __pyx_pybuffernd_GCFL_int.rcbuffer->pybuffer.buf, __pyx_t_50, __pyx_pybuffernd_GCFL_int.diminfo[0].strides, __pyx_t_51, __pyx_pybuffernd_GCFL_int.diminfo[1].strides))); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_2);
          __pyx_t_7 = PyNumber_Add(__pyx_v_g, __pyx_t_2); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_7);
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __pyx_t_52 = __Pyx_PyInt_As_int(__pyx_t_7); if (unlikely((__pyx_t_52 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
          __pyx_v_k1 = __pyx_t_52;

          /* "DECSKS/lib/source_advection.pyx":89
 *                     # both proportions map on-grid to points (g + GCFL.int[s,j]) and (g + GCFL.int[s,j] - 1)
 *                     k1 = g + GCFL_int[s,j]
 *                     k2 = k1 - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_v_k2 = (__pyx_v_k1 - 1);

          /* "DECSKS/lib/source_advection.pyx":91
 *                     k2 = k1 - 1
 * 
 *                     f_S[s,k1,j] +=  S[j] * (1 + GCFL_frac[s,j])             # <<<<<<<<<<<<<<
 ...
 */
          ...
          if (__pyx_t_52 < 0) __pyx_t_52 += __pyx_pybuffernd_S.diminfo[0].shape;
          __pyx_t_53 = __pyx_v_s;
          __pyx_t_54 = __pyx_v_j;
          if (__pyx_t_53 < 0) __pyx_t_53 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
          if (__pyx_t_54 < 0) __pyx_t_54 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
          __pyx_t_55 = __pyx_v_s;
          __pyx_t_56 = __pyx_v_k1;
          __pyx_t_57 = __pyx_v_j;
          if (__pyx_t_55 < 0) __pyx_t_55 += __pyx_pybuffernd_f_S.diminfo[0].shape;
          if (__pyx_t_56 < 0) __pyx_t_56 += __pyx_pybuffernd_f_S.diminfo[1].shape;
          if (__pyx_t_57 < 0) __pyx_t_57 += __pyx_pybuffernd_f_S.diminfo[2].shape;
          *__Pyx_BufPtrStrided3d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_f_S.rcbuffer->pybuffer.buf, __pyx_t_55, __pyx_pybuffernd_f_S.diminfo[0].strides, __pyx_t_56, __pyx_pybuffernd_f_S.diminfo[1].strides, __pyx_t_57, __pyx_pybuffernd_f_S.diminfo[2].strides) += ((*__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_S.rcbuffer->pybuffer.buf, __pyx_t_52, __pyx_pybuffernd_S.diminfo[0].strides)) * (1.0 + (*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_53, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_54, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides))));

          /* "DECSKS/lib/source_advection.pyx":92
 * 
 *                     f_S[s,k1,j] +=  S[j] * (1 + GCFL_frac[s,j])
 *                     f_S[s,k2,j] += -S[j] *  GCFL_frac[s,j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          if (__pyx_t_58 < 0) __pyx_t_58 += __pyx_pybuffernd_S.diminfo[0].shape;
          __pyx_t_59 = __pyx_v_s;
          __pyx_t_60 = __pyx_v_j;
          if (__pyx_t_59 < 0) __pyx_t_59 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
          if (__pyx_t_60 < 0) __pyx_t_60 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
          __pyx_t_61 = __pyx_v_s;
          __pyx_t_62 = __pyx_v_k2;
          __pyx_t_63 = __pyx_v_j;
          if (__pyx_t_61 < 0) __pyx_t_61 += __pyx_pybuffernd_f_S.diminfo[0].shape;
          if (__pyx_t_62 < 0) __pyx_t_62 += __pyx_pybuffernd_f_S.diminfo[1].shape;
          if (__pyx_t_63 < 0) __pyx_t_63 += __pyx_pybuffernd_f_S.diminfo[2].shape;
          *__Pyx_BufPtrStrided3d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_f_S.rcbuffer->pybuffer.buf, __pyx_t_61, __pyx_pybuffernd_f_S.diminfo[0].strides, __pyx_t_62, __pyx_pybuffernd_f_S.diminfo[1].strides, __pyx_t_63, __pyx_pybuffernd_f_S.diminfo[2].strides) += ((-(*__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_S.rcbuffer->pybuffer.buf, __pyx_t_58, __pyx_pybuffernd_S.diminfo[0].strides))) * (*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_59, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_60, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides)));
          goto __pyx_L9;
        }

        /* "DECSKS/lib/source_advection.pyx":94
 *                     f_S[s,k2,j] += -S[j] *  GCFL_frac[s,j]
 * 
 *                 elif g == NG-1:             # <<<<<<<<<<<<<<
 ...
 */
        __pyx_t_7 = PyNumber_Subtract(__pyx_v_NG, __pyx_int_1); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_7);
        __pyx_t_2 = PyObject_RichCompare(__pyx_v_g, __pyx_t_7, Py_EQ); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __pyx_t_19 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_19 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        if (__pyx_t_19) {

          /* "DECSKS/lib/source_advection.pyx":98
 *                     # physically k2 = Nx-1, k1 = Nx (off-grid, ghost region)
 * 
 *                     k2 = Nx-1             # <<<<<<<<<<<<<<
 *                     f_S[s,k2,j] += -S[j] *  GCFL_frac[s,j]
 * 
 */
          __pyx_v_k2 = (__pyx_v_Nx - 1);

          /* "DECSKS/lib/source_advection.pyx":99
 * 
 *                     k2 = Nx-1
 *                     f_S[s,k2,j] += -S[j] *  GCFL_frac[s,j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          if (__pyx_t_64 < 0) __pyx_t_64 += __pyx_pybuffernd_S.diminfo[0].shape;
          __pyx_t_65 = __pyx_v_s;
          __pyx_t_66 = __pyx_v_j;
          if (__pyx_t_65 < 0) __pyx_t_65 += __pyx_pybuffernd_GCFL_frac.diminfo[0].shape;
          if (__pyx_t_66 < 0) __pyx_t_66 += __pyx_pybuffernd_GCFL_frac.diminfo[1].shape;
          __pyx_t_67 = __pyx_v_s;
          __pyx_t_68 = __pyx_v_k2;
          __pyx_t_69 = __pyx_v_j;
          if (__pyx_t_67 < 0) __pyx_t_67 += __pyx_pybuffernd_f_S.diminfo[0].shape;
          if (__pyx_t_68 < 0) __pyx_t_68 += __pyx_pybuffernd_f_S.diminfo[1].shape;
          if (__pyx_t_69 < 0) __pyx_t_69 += __pyx_pybuffernd_f_S.diminfo[2].shape;
          *__Pyx_BufPtrStrided3d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_f_S.rcbuffer->pybuffer.buf, __pyx_t_67, __pyx_pybuffernd_f_S.diminfo[0].strides, __pyx_t_68, __pyx_pybuffernd_f_S.diminfo[1].strides, __pyx_t_69, __pyx_pybuffernd_f_S.diminfo[2].strides) += ((-(*__Pyx_BufPtrStrided1d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_S.rcbuffer->pybuffer.buf, __pyx_t_64, __pyx_pybuffernd_S.diminfo[0].strides))) * (*__Pyx_BufPtrStrided2d(__pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t *, __pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer.buf, __pyx_t_65, __pyx_pybuffernd_GCFL_frac.diminfo[0].strides, __pyx_t_66, __pyx_pybuffernd_GCFL_frac.diminfo[1].strides)));
          goto __pyx_L9;
        }
        /*else*/ {
        }
 ...
 */
  ...
  /* "DECSKS/lib/source_advection.pyx":114
 *     #
 ...
 * 
 */
  __pyx_t_4 = PyFloat_FromDouble(__pyx_v_xwidth); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = PyNumber_InPlaceMultiply(((PyObject *)__pyx_v_N_S), __pyx_t_4); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_N_S.rcbuffer->pybuffer);
    __pyx_t_11 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_N_S.rcbuffer->pybuffer, (PyObject*)__pyx_t_9, &__Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_11 < 0)) {
      PyErr_Fetch(&__pyx_t_70, &__pyx_t_71, &__pyx_t_72);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_N_S.rcbuffer->pybuffer, (PyObject*)__pyx_v_N_S, &__Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
    ...
    __pyx_pybuffernd_N_S.diminfo[0].strides = __pyx_pybuffernd_N_S.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_N_S.diminfo[0].shape = __pyx_pybuffernd_N_S.rcbuffer->pybuffer.shape[0];
    if (unlikely(__pyx_t_11 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_9 = 0;
  __Pyx_DECREF_SET(__pyx_v_N_S, ((PyArrayObject *)__pyx_t_2));
  __pyx_t_2 = 0;

  /* "DECSKS/lib/source_advection.pyx":115
 *     # factor in multiplicative prefactors to all entry N_S[s]:
 *     N_S *= xwidth
 *     N_S *= vxwidth             # <<<<<<<<<<<<<<
 * 
 *     return f_S, N_S
 */
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_vxwidth); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = PyNumber_InPlaceMultiply(((PyObject *)__pyx_v_N_S), __pyx_t_2); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_9 = ((PyArrayObject *)__pyx_t_4);
  {
    ...
    __pyx_t_11 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_N_S.rcbuffer->pybuffer, (PyObject*)__pyx_t_9, &__Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_11 < 0)) {
      PyErr_Fetch(&__pyx_t_72, &__pyx_t_71, &__pyx_t_70);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_N_S.rcbuffer->pybuffer, (PyObject*)__pyx_v_N_S, &__Pyx_TypeInfo_nn___pyx_t_6DECSKS_3lib_16source_advection_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
        Py_XDECREF(__pyx_t_72); Py_XDECREF(__pyx_t_71); Py_XDECREF(__pyx_t_70);
        __Pyx_RaiseBufferFallbackError();
      } else {
        PyErr_Restore(__pyx_t_72, __pyx_t_71, __pyx_t_70);
      }
    }
    __pyx_pybuffernd_N_S.diminfo[0].strides = __pyx_pybuffernd_N_S.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_N_S.diminfo[0].shape = __pyx_pybuffernd_N_S.rcbuffer->pybuffer.shape[0];
  ...
  __pyx_t_9 = 0;
  __Pyx_DECREF_SET(__pyx_v_N_S, ((PyArrayObject *)__pyx_t_4));
  __pyx_t_4 = 0;

  /* "DECSKS/lib/source_advection.pyx":117
 *     N_S *= vxwidth
 * 
 *     return f_S, N_S             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_INCREF(((PyObject *)__pyx_v_f_S));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_f_S));
  PyTuple_SET_ITEM(__pyx_t_4, 0, ((PyObject *)__pyx_v_f_S));
  __Pyx_INCREF(((PyObject *)__pyx_v_N_S));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_N_S));
  PyTuple_SET_ITEM(__pyx_t_4, 1, ((PyObject *)__pyx_v_N_S));
  __pyx_r = __pyx_t_4;
  __pyx_t_4 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_GCFL_frac.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_GCFL_int.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_N_S.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_S.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_f_S.rcbuffer->pybuffer);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_f_S.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_f_S);
  __Pyx_XDECREF((PyObject *)__pyx_v_N_S);
  __Pyx_XDECREF(__pyx_v_NG);
  __Pyx_XDECREF(__pyx_v_g_crit);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_s_DECSKS_lib_source_advection, __pyx_k_DECSKS_lib_source_advection, sizeof(__pyx_k_DECSKS_lib_source_advection), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_GCFL_frac, __pyx_k_GCFL_frac, sizeof(__pyx_k_GCFL_frac), 0, 0, 1, 1},
  {&__pyx_n_s_GCFL_int, __pyx_k_GCFL_int, sizeof(__pyx_k_GCFL_int), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_Nvx, __pyx_k_Nvx, sizeof(__pyx_k_Nvx), 0, 0, 1, 1},
  {&__pyx_n_s_Nx, __pyx_k_Nx, sizeof(__pyx_k_Nx), 0, 0, 1, 1},
  {&__pyx_n_s_RuntimeError, __pyx_k_RuntimeError, sizeof(__pyx_k_RuntimeError), 0, 0, 1, 1},
  {&__pyx_n_s_S, __pyx_k_S, sizeof(__pyx_k_S), 0, 0, 1, 1},
  {&__pyx_n_s_S_Nvx, __pyx_k_S_Nvx, sizeof(__pyx_k_S_Nvx), 0, 0, 1, 1},
  {&__pyx_n_s_ValueError, __pyx_k_ValueError, sizeof(__pyx_k_ValueError), 0, 0, 1, 1},
  {&__pyx_n_s_abs, __pyx_k_abs, sizeof(__pyx_k_abs), 0, 0, 1, 1},
  {&__pyx_n_s_create_postpoint_objects, __pyx_k_create_postpoint_objects, sizeof(__pyx_k_create_postpoint_objects), 0, 0, 1, 1},
  {&__pyx_n_s_f_S, __pyx_k_f_S, sizeof(__pyx_k_f_S), 0, 0, 1, 1},
  {&__pyx_n_s_float64, __pyx_k_float64, sizeof(__pyx_k_float64), 0, 0, 1, 1},
  {&__pyx_n_s_g, __pyx_k_g, sizeof(__pyx_k_g), 0, 0, 1, 1},
  {&__pyx_n_s_g_crit, __pyx_k_g_crit, sizeof(__pyx_k_g_crit), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_num_stages, __pyx_k_num_stages, sizeof(__pyx_k_num_stages), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_vxwidth, __pyx_k_vxwidth, sizeof(__pyx_k_vxwidth), 0, 0, 1, 1},
 ...
 *                              np.ndarray[DTYPE_t, ndim=2] GCFL_frac,
 */
  __pyx_tuple__7 = PyTuple_Pack(20, __pyx_n_s_S, __pyx_n_s_GCFL_int, __pyx_n_s_GCFL_frac, __pyx_n_s_num_stages, __pyx_n_s_Nx, __pyx_n_s_Nvx, __pyx_n_s_xwidth, __pyx_n_s_vxwidth, __pyx_n_s_sim_params, __pyx_n_s_S_Nvx, __pyx_n_s_s, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k1, __pyx_n_s_k2, __pyx_n_s_f_S, __pyx_n_s_N_S, __pyx_n_s_NG, __pyx_n_s_g_crit, __pyx_n_s_g); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(9, 0, 20, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_dsirajud_Work_IPython_note, __pyx_n_s_create_postpoint_objects, 12, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initsource_advection(void); /*proto*/
PyMODINIT_FUNC initsource_advection(void)
#else
PyMODINIT_FUNC PyInit_source_advection(void); /*proto*/
PyMODINIT_FUNC PyInit_source_advection(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_source_advection(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("source_advection", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_DECSKS__lib__source_advection) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "DECSKS.lib.source_advection")) {
      if (unlikely(PyDict_SetItemString(modules, "DECSKS.lib.source_advection", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "DECSKS/lib/source_advection.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 */
  ...
  /* "DECSKS/lib/source_advection.pyx":5
 * cimport cython
 * 
 * DTYPE = np.float64             # <<<<<<<<<<<<<<
 * DTYPEINT = np.int64
 ...
 */
  ...
  /* "DECSKS/lib/source_advection.pyx":6
 * 
 * DTYPE = np.float64
 * DTYPEINT = np.int64             # <<<<<<<<<<<<<<
 * 
 ...
 *                              np.ndarray[DTYPE_t, ndim=2] GCFL_frac,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6DECSKS_3lib_16source_advection_1create_postpoint_objects, NULL, __pyx_n_s_DECSKS_lib_source_advection); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_create_postpoint_objects, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init DECSKS.lib.source_advection", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init DECSKS.lib.source_advection");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
