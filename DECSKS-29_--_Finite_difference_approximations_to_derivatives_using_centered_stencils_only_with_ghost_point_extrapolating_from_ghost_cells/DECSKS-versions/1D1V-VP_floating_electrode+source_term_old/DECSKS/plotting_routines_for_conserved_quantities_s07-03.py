...
plt.semilogy(t, I1, 'oc', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s07-03')
...
I1 = np.abs((I1 - I1[0]) / I1[0])
plt.semilogy(t, I1, '*m', markersize = 10, linewidth = 2, label = 'DECSKS-1.2: s07-01')

# s07-02
I1 = file_to_array(quantity = 'I1', notebook_number = 7, sim_number = 2, version = 1.2)
I1 = np.abs((I1 - I1[0]) / I1[0])
plt.semilogy(t_fine, I1, '-g', linewidth = 2, label = 'DECSKS-1.2: s07-02')
...
plt.semilogy(t, I2, 'oc', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s07-03')
...
I2 = np.abs((I2 - I2[0]) / I2[0])
plt.semilogy(t, I2, '*m', markersize = 10, linewidth = 2, label = 'DECSKS-1.2: s07-01')

# s07-02
I2 = file_to_array(quantity = 'I2', notebook_number = 7, sim_number = 2, version = 1.2)
I2 = np.abs((I2 - I2[0]) / I2[0])
plt.semilogy(t_fine, I2, '-g', linewidth = 2, label = 'DECSKS-1.2: s07-02')
...
plt.semilogy(t, IW, 'oc', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s07-03')
...
IW = np.abs((IW - IW[0]) / IW[0])
plt.semilogy(t, IW, '*m', markersize = 10, linewidth = 2, label = 'DECSKS-1.2: s07-01')

# s07-02
IW = file_to_array(quantity = 'IW', notebook_number = 7, sim_number = 2, version = 1.2)
IW = np.abs((IW - IW[0]) / IW[0])
plt.semilogy(t_fine, IW, '-g', linewidth = 2, label = 'DECSKS-1.2: s07-02')
...
S = np.abs((S - S[0]) / S[0])
plt.semilogy(t, S, 'oc', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s07-03')
...
S = np.abs((S - S[0]) / S[0])
plt.semilogy(t, S, '*m', markersize = 10, linewidth = 2, label = 'DECSKS-1.2: s07-01')

# s07-02
S = file_to_array(quantity = 'S', notebook_number = 7, sim_number = 2, version = 1.2)
S = np.abs((S - S[0]) / S[0])
plt.semilogy(t_fine, S, '-g', linewidth = 2, label = 'DECSKS-1.2: s07-02')
...
WE = WE / WE[0]
plt.semilogy(t, WE, 'oc', markersize = 12, linewidth = 2, label = 'DECSKS-2.3: s07-03')
...
WE = WE / WE[0]
plt.semilogy(t, WE, '*m', markersize = 10, linewidth = 2, label = 'DECSKS-1.2: s07-01')

# s07-02
WE = file_to_array(quantity = 'WE', notebook_number = 7, sim_number = 2, version = 1.2)
WE = WE / WE[0]
plt.semilogy(t_fine, WE, '-g', linewidth = 2, label = 'DECSKS-1.2: s07-02')
