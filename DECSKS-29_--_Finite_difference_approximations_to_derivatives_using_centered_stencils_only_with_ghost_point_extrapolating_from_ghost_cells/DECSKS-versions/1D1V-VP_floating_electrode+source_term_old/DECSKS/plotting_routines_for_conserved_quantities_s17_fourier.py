...
# s17-01
I1 = file_to_array(quantity = 'I1', notebook_number = 17, sim_number = 1)
...
# s17-01
I2 = file_to_array(quantity = 'I2', notebook_number = 17, sim_number = 1)
...
# s17-01
IW = file_to_array(quantity = 'IW', notebook_number = 17, sim_number = 1)
...
# s17-01
S = file_to_array(quantity = 'S', notebook_number = 17, sim_number = 1)
S = np.abs((S - S[0]) / S[0])
...
# s17-01
WE = file_to_array(quantity = 'WE', notebook_number = 17, sim_number = 1)
WE = WE / WE[0]
