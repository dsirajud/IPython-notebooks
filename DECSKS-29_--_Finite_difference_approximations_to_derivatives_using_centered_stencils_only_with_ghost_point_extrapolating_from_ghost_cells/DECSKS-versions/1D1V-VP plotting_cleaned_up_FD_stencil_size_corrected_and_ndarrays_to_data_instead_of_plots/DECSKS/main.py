...
with open(dir_path + sim_name + '_--_grid_xaxis.npy', 'w') as abscissa:
    np.save(abscissa, x.gridvalues)

with open(dir_path + sim_name + '_--_grid_yaxis.npy', 'w') as ordinate:
    np.save(ordinate, vx.gridvalues)
