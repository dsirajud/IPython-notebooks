...
def compute_electric_field_fd(fe, fi, x, vx, n, sim_params):
    ...
    DECSKS.lib.write.tofiles(sim_params['sim_name'], n, phi = phi[:,0]) # all cols are identical
...
def Poisson_6th_LNBC_UDBC(fe, fi,
    ...
    if sim_params['BC']['phi'][x.str]['lower'] == 'SYMMETRIC' or sim_params['BC']['phi'][x.str]['lower'] == 'SYMMETRY':
        ...
        sim_params['phi_BC'][x.str][0] = - x.width * sim_params['sigma'][x.str]['lower'] # general condition is x.width * LNBC
                                                                                         # here, dphi = -E = -sigma = LNBC
