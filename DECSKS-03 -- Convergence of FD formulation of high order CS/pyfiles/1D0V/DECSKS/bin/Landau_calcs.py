...
# WE
# COARSE SOLUTION
infile = open('./../etc/outputs/out_WE_coarse','r')
...
# IW
# COARSE SOLUTION
infile = open('./../etc/outputs/out_IW_coarse','r')
lines = infile.readlines()
...
# CONVERGED SOLUTION
infile = open('./../etc/outputs/out_IW_converged','r')
lines = infile.readlines()
...
plt.savefig('./../etc/outputs/Landau_IW.png')
plt.clf()

# S
# COARSE SOLUTION
infile = open('./../etc/outputs/out_S_coarse','r')
lines = infile.readlines()
...
# CONVERGED SOLUTION
infile = open('./../etc/outputs/out_S_converged','r')
lines = infile.readlines()
...
plt.savefig('./../etc/outputs/Landau_S.png')
plt.clf()

# I2
# COARSE SOLUTION
infile = open('./../etc/outputs/out_I2_coarse','r')
lines = infile.readlines()
...
# CONVERGED I2OLUTION
infile = open('./../etc/outputs/out_I2_converged','r')
lines = infile.readlines()
...
plt.axis([0, 60, 1e-16, 1e-6])
plt.legend(loc = 'best')
plt.savefig('./../etc/outputs/Landau_I2.png')
plt.clf()

# I1
# COARSE SOLUTION
infile = open('./../etc/outputs/out_I1_coarse2','r')
lines = infile.readlines()
...
# CONVERGED I1OLUTION
infile = open('./../etc/outputs/out_I1_converged','r')
lines = infile.readlines()
...
plt.legend(loc = 'best')
plt.axis([0, 60, 1e-16, 1e-6])
plt.savefig('./../etc/outputs/Landau_I1.png')
plt.clf()
