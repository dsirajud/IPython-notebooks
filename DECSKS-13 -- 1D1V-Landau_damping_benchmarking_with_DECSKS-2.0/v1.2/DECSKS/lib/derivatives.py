...
def finite_differences_periodic_BCs(f,z):
...
def assemble_finite_difference_weight_matrices(sim_params, x, v):
    ...
    W['v'] = assemble_finite_difference_weight_matrix(sim_params, v)
...
def assemble_finite_difference_weight_matrix(sim_params, z):
    ...
    for dn in range(1,sim_params['N']):
        ...
        p = sim_params['N'] - dn + 1 # LTE of scheme on dn-th derivative so that
