...
infile = open('../../../../v1.2/DECSKS/etc/outputs/s7-01/out_I1','r')
lines = infile.readlines()
...
infile = open('../../../../v1.2/DECSKS/etc/outputs/s7-02/out_I1','r')
lines = infile.readlines()
...
plt.ylabel(r'Abs. value of the fractional error in $L_1$ norm', fontsize = 12)
plt.legend(loc = 'best')
