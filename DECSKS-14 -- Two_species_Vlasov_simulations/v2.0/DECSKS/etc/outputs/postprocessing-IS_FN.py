...
infile = open('../../../../v1.2/DECSKS/etc/outputs/s7-01/out_S','r')
lines = infile.readlines()
...
infile = open('../../../../v1.2/DECSKS/etc/outputs/s7-02/out_S','r')
lines = infile.readlines()
...
plt.ylabel(r'Abs. value of the fractional error in entropy $S$', fontsize = 12)
plt.legend(loc = 'best')
