...
infile = open('../../../../v1.2/DECSKS/etc/outputs/s7-01/out_IW','r')
lines = infile.readlines()
...
plt.semilogy(t, WE, '*', color = tableau20[5], linewidth = 2,
             label = 's7-01')


##### s13-02

infile = open('../../../../v1.2/DECSKS/etc/outputs/s7-02/out_IW','r')
lines = infile.readlines()
...
plt.ylabel(r'Abs. value of the fractional error in total energy $I_W$', fontsize = 12)
plt.legend(loc = 'best')
