...
def inputfile(filename):
   ...
   # --------------------------------------------------------------------------
    ...
    sim_params = dict(
        ...
        Nt = Nt, T = T,
        vx_inflection_gridpoint = vx_inflection_gridpoint,
