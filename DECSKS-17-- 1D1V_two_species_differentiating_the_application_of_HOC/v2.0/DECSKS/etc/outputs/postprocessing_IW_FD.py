...
infile = open('../../../../v1.2/DECSKS/etc/outputs/s7-03/out_S','r')
lines = infile.readlines()
...
plt.ylabel('Fractional error in total entropy $I_S$', fontsize = 12)
plt.legend(loc = 'best')
plt.savefig('Landau_S_FD.png')
plt.clf()
